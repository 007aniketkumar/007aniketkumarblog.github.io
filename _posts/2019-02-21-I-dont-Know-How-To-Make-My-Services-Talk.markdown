...
Moreover, there are cases which justify maintaining stateful services, how you handle the state amongst the services is a more important question to answer. The SAGA pattern shines here https://microservices.io/patterns/data/saga.html.
